...
let strPanjang = parseInt(panjangPersegiPanjang)
let strLebar = parseInt(lebarPersegiPanjang)
let kelilingPersegiPanjang = 2 * ( strPanjang + strLebar );
...
var isiAngka = angka = 2 ? "angkanya 2" : "bukan angka 2";
...
switch(traffic_lights) {
    ...
    case "green":   { console.log('berjalan'); }
}